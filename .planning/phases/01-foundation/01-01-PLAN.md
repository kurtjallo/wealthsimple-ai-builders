...
must_haves:
  truths:
    ...
    - "All core dependencies installed (next, react, supabase-js, @google/generative-ai, shadcn components)"
...
<task type="auto">
  ...
  <action>
    ...
    2. Install all project dependencies in one command:
       ```
       npm install @supabase/supabase-js @google/generative-ai lucide-react class-variance-authority clsx tailwind-merge
       ```
...
- All dependencies installed for Supabase, Google GenAI SDK, Mistral, and UI
